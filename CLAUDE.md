...
**Este scanner:** referência de preço = `tcgcsv.com` apenas (campo market → mid → low, rastreado em `price_field`); chaves = `FIRECRAWL_API_KEY` (só pro scan na nuvem, hoje dormente; roda local headful).
